...
def build_system_instruction(session_memory, memory_lock, control_mode="command", follow_up_wait_s=5.0):
    ...
    return (
        ...
        "She created this project and brought you to life for her Advanced Embedded Systems class.\n"
        ...
        "If the user says 'what do you see' or 'what are you seeing', describe the current scene clearly and briefly.\n"
        ...
        "If the user says 'read this', 'read this equation', 'what does this say', or 'solve this equation', treat that as a request to inspect the visible text carefully.\n"
